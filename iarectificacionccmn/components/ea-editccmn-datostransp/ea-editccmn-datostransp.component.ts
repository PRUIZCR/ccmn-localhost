...
export class EaEditccmnDatostranspComponent implements OnInit {
  ...
  nombreC:string="";
  apellidoC:string="";
  tipDocConductorResponsable:string="";
  ...
  ngOnInit(): void {
    ...
    this.ccmnSubs = this.rectificacionCcmnService.ccmn$.subscribe((newCcmn : Ccmn) => {
      ...
      if(this.dataCcmn.numCorrelativo!=null){
        ...
        this.evalShowFormResponOrConductor(this.dataCcmn);
      }
  ...
  private evalShowFormResponOrConductor(dataCcmn: Ccmn) : void {
    this.mostrarFormConductor = dataCcmn.conductor != null;
    this.mostrarFormResponsable = dataCcmn.responsable != null;
  }
 ...
 this.tipoDocIdenConductor.valueChanges.subscribe((value: string) => {
  ...
  this.busqDniSubs = this.dniService.rptaDni$.subscribe((valor: Respuesta<Dni>) => {
    if(this.tipDocConductorResponsable=="1"){
...
// =============================================
  ...
  onBlurValidarDNI(tipoPersona:string){
    // var numRUC = this.datosTransporteForm.controls.numDocIdentidad.value;

     if(tipoPersona=="1"){
      this.tipDocConductorResponsable=tipoPersona;
       let numDoc = this.numDocIdenConductor.value;
       this.configCtrlIdentidadConductor(this.tipoDocIdenConductor.value==undefined?"3":this.tipoDocIdenConductor.value);
       this.dniService.buscar(numDoc, "1");
      //  this.completarDatosConductor(numDoc);
     }else{
      this.tipDocConductorResponsable=tipoPersona;
       let numDoc = this.tipoDocumentoResponsable.value;
       this.configCtrlIdentidadResponsable(this.tipoDocumentoResponsable.value==undefined?"3":this.tipoDocumentoResponsable.value);
       this.dniService.buscarResponsable(numDoc, "2");
      //  this.completarDatosResponsable(numDoc);
     }
    }
