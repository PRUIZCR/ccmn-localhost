...
upperCase(data:PuestoControl[]){
            ...
            this.perfilesUsuarioService.buscar(this.usuarioLogin, "CPASO_JEFE_SUPERVISOR")
              ...
              (err:HttpErrorResponse)=>{
                if(err.error instanceof Error){
                  ...
                  this.messageService.add({ key: 'msj', severity: 'warn', detail: 'Error servidor remoto JEFE 422' });
                }else{
  ...
  this.perfilesUsuarioService.buscar(usuario,perfilFuncionario )
    .subscribe( (data : PerfilUsuario[]) => {
      ...
      if(!err){
        ...
        this.getPerfilRegistro(usuario,paramConsultar,perfilFuncionario);
        // this.messageService.clear();
...
function ajax(response: any): any {
